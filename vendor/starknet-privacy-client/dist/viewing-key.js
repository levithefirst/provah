 ...
 */
function passphraseToFelts(passphrase) {
 ...
 */
export function deriveViewingKey(passphrase, address) {
 ...
 */
function canonicalViewingKey(key) {
 ...
 */
export function passphraseViewingKeyProvider(passphrase, address) {
    let cached;
