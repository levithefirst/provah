...
const STARKNET_DOMAIN_TYPE_HASH = 0x1ff2f602e42168014d405a94f75e8a93d640751d71d16311266e140d8b0a210n;
...
function hashCallSet(calls, additionalData) {
    return poseidon([
        CALL_SET_TYPE_HASH,
 ...
 * passes it empty.
 */
export function computeCallSetHash(accountAddress, calls, chainId, additionalData = []) {
 ...
 */
export class Snip12CallSetSigner {
    options;
    constructor(options) {
        this.options = options;
    }
    async signTransaction(calls, _details) {
        const messageHash = computeCallSetHash(this.options.accountAddress, calls, this.options.chainId, this.options.additionalData ?? []);
...
//# sourceMappingURL=snip12-call-set-signer.js.map