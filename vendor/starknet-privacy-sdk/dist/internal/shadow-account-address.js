 ...
 */
export const PRIMER_CLASS_HASH = 0x00123e6bc1c14ae9934e933d3f64916a6116dd6b036a922b2b1f0815e0d1d300n;
/**
 ...
 * before calling.
 */
export function shadowAccountPartialCommitment(user, viewingKey, anonymizerAddress, dappName) {
 ...
 */
export function shadowAccountCommitment(partialCommitment, nonce) {
 ...
 */
export function shadowAccountAddress(commitment, anonymizerAddress) {
    return toBigInt(starknetHash.calculateContractAddressFromHash(commitment, PRIMER_CLASS_HASH, [], anonymizerAddress));
}
//# sourceMappingURL=shadow-account-address.js.map