  ...
  return (
    <section className="bg-neutral-50 py-24 dark:bg-neutral-900/40">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <a
          href="#app"
          className="mt-8 inline-block rounded-full bg-neutral-900 px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-neutral-900/10 transition-all hover:-translate-y-0.5 hover:bg-neutral-800 active:translate-y-0 dark:bg-white dark:text-neutral-900 dark:shadow-none dark:hover:bg-neutral-200"
        >
          Try the live demo
        </a>
      </div>
